...
class NodeMonitorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Heartbeat = channel.stream_unary(
                '/monitor.NodeMonitor/Heartbeat',
                request_serializer=monitor__pb2.HeartbeatRequest.SerializeToString,
                response_deserializer=monitor__pb2.HeartbeatResponse.FromString,
...
def add_NodeMonitorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Heartbeat': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=monitor__pb2.HeartbeatResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'monitor.NodeMonitor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('monitor.NodeMonitor', rpc_method_handlers)
...
class NodeMonitor(object):
    ...
    def Heartbeat(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            monitor__pb2.HeartbeatResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
